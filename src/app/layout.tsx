...
export const metadata: Metadata = {
  title: "Brew Haven - Artisan Coffee Shop",
  description: "Discover specialty coffee crafted with passion. Premium beans, expert baristas, and ethical sourcing. Your perfect cup awaits.",
  keywords: "coffee shop, specialty coffee, artisan roasts, barista, ethically sourced",
  ...
  openGraph: {
    ...
    description: "Discover specialty coffee crafted with passion. Premium beans, expert baristas, and ethical sourcing.",
    type: "website",
    siteName: "Brew Haven",
    images: [
      {
        url: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_30ordogEOn7VO6LZdIWb5atLXky/uploaded-1765898512842-cey3gkf6.jpg",
  ...
  twitter: {
    ...
    title: "Brew Haven - Premium Artisan Coffee",
    description: "Discover specialty coffee crafted with passion",
    images: ["https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_30ordogEOn7VO6LZdIWb5atLXky/uploaded-1765898512842-cey3gkf6.jpg"]
  },
  robots: {
    index: true,
    follow: true
